        ...
        {socialLinks && Object.keys(socialLinks).length > 0 && (
          <footer className="flex justify-center gap-3 my-4">
            <Social url={socialLinks?.facebook}>
              <FaFacebook size={35} color="#fff" className="hover:scale-105" />
            </Social>

            <Social url={socialLinks?.instagram}>
              <FaInstagram size={35} color="#fff" className="hover:scale-105" />
            </Social>

            <Social url={socialLinks?.youtube}>
              <FaYoutube size={35} color="#fff" className="hover:scale-105" />
            </Social>
          </footer>
        )}
      </main>
